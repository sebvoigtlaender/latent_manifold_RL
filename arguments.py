...
def get_args():
    ...
    parser.add_argument('--act-fn', default='relu', help='activation function (default: relu)')
    ...
    parser.add_argument('--std', default=1e-1, help='standard deviation for evolution strategy noise (default: 1e-1)')
